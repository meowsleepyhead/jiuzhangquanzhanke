...
public class CourseService {
    ...
    public List<Course> updateCourse(String selectedCourseName, Course updateCourse){

        return courseRepository.updateCourseByName(selectedCourseName, updateCourse);
    }
